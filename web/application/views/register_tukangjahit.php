		...
		<div class="col-sm-8 main-section">
			<div class="modal-content">
				<div class="col-12 user-img">
					<img src="../assets/img/women.png" class="logo-circle">
					
				</div>
				<form class="col-12">
					<div class="form-group">
						<input type="password" name="nama_tj" class="form-control" placeholder="Enter Name">
					</div>
					<div class="form-group">
						<input type="text" name="username_tj" class="form-control" placeholder="enter username Tukang Jahit">
					</div>
					<div class="form-group">
						<input type="password" name="password_tj" class="form-control" placeholder="enter password Tukang Jahit">
					</div>
					<button type="submit" class="btn btn-red"><i class="fa fa-save"></i> Register</button>
				</form>
